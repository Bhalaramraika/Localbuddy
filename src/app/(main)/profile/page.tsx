...
const ProfileHeader = () => (
  <div className="flex flex-col items-center pt-10 pb-6 px-4 glass-card rounded-b-3xl rounded-t-none">
    ...
    <h1 className="text-2xl font-bold text-center text-white mt-4 drop-shadow-lg">Rahul Smith</h1>
    <p className="text-white/70 drop-shadow-lg">Level 2: Pro</p>
  </div>
);
        ...
        <div className="relative glass-card p-4 mx-4 rounded-3xl">
            <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold text-white drop-shadow-lg">XP: 350 / 500</p>
                </div>
            </div>
            <Progress value={xpPercentage} className="h-2 [&>div]:bg-gradient-to-r [&>div]:from-purple-500 [&>div]:to-primary glass-card" />
      </div>
    );
}
    ...
    <div className="glass-card p-6 mx-4 rounded-3xl">
        <div className="grid grid-cols-3 gap-4 text-center">
            <div>
                ...
                <p className="text-xs text-white/70 drop-shadow-lg">Total Earnings</p>
            </div>
            <div>
                <p className="text-2xl font-bold text-white drop-shadow-lg">25</p>
                <p className="text-xs text-white/70 drop-shadow-lg">Tasks</p>
            </div>
             <div>
                <p className="text-2xl font-bold text-white flex items-center justify-center gap-1 drop-shadow-lg">4.8 <Star className="h-4 w-4 text-secondary"/></p>
                <p className="text-xs text-white/70 drop-shadow-lg">Rating</p>
            </div>
        </div>
    </div>
)
        ...
        <div className="grid grid-cols-3 gap-4">
            {badges.map(badge => (
                <div key={badge.name} className="flex flex-col items-center text-center p-2 rounded-lg glass-card">
                    ...
                    <p className="text-xs font-semibold text-white/80 drop-shadow-lg">{badge.name}</p>
                </div>
            ))}
        </div>
    </div>
