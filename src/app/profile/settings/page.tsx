...
const SettingsItem = ({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) => (
...
export default function SettingsPage() {
    const settingsOptions = [
        { icon: <User className="w-6 h-6 text-main-accent"/>, title: "Account", description: "Manage your profile information" },
        { icon: <Bell className="w-6 h-6 text-yellow-500"/>, title: "Notifications", description: "Choose what you get notified about" },
        { icon: <Lock className="w-6 h-6 text-green-500"/>, title: "Privacy & Security", description: "Control your data and security" },
        { icon: <HelpCircle className="w-6 h-6 text-blue-500"/>, title: "Help & Support", description: "Get help or contact us" },
        { icon: <FileText className="w-6 h-6 text-purple-500"/>, title: "Terms & Conditions", description: "Read our terms of service" },
    ];
