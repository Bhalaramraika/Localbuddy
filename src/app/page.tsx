  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden p-4">
      <div className="w-full max-w-md mx-auto p-8 animate-fade-in-up">
        <div className="glass-card p-8 text-center shadow-2xl rounded-3xl">
          ...
          <div className="space-y-4">
            <Button
              className="w-full h-14 text-lg font-semibold bg-primary text-primary-foreground hover:bg-primary/90 cyan-glow glass-card rounded-xl"
              asChild
            >
              <Link href="/home">
                Login
            ...
            <Button variant="ghost" className="w-full h-14 text-lg font-semibold text-muted-foreground glass-card rounded-xl" asChild>
